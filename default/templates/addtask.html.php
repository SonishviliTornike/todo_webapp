...
<form action="addtask.php" method="post">
    ...
    <textarea id="task_description" name="task_description" rows="4" cols="50" required><?= htmlspecialchars($old_values['task_description'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea><br><br>
